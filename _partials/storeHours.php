...
$open_now = "<br><strong class='open'>Yes, we're open! Today's hours are %open% until %closed%.</strong>";
$closed_now = "<br><strong class='closed'>Sorry, we're closed. Today's hours are %open% until %closed%.</strong>";
$closed_all_day = "<br><strong class='closed'>Sorry, we're closed on %day%.</strong>";
$exception = "<br><strong class='closed'>Sorry, we're closed for %exception%.</strong>";
